    ...
    return (
        <aside className="bg-background text-foreground p-6 w-full shrink-0 space-y-8 text-sm">
            ...
            <section className="space-y-3">
                ...
                <div className="space-y-1">
                    <FilterOption
                        active={filters.privacy === "all"}
                        onClick={() =>
                            onChange({ ...filters, privacy: "all" })
                        }
                        icon={Layers}
                    >
                        Show all adventures
                    ...
                    <FilterOption
                        active={filters.privacy === "public"}
                        onClick={() =>
                            onChange({ ...filters, privacy: "public" })
                        }
                        icon={Globe}
                    >
                        Public only
                    ...
                    <FilterOption
                        active={filters.privacy === "private"}
                        onClick={() =>
                            onChange({ ...filters, privacy: "private" })
                        }
                        icon={Lock}
                    >
                        Private only
